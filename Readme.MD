...
| Processing & Sidebar | Mathematical Output & Code | Full Width Mode | Analogies & Explanations |
|:---:|:---:|:---:|:---:|
| <img src="Screenshot 2026-03-18 at 17.56.25.png" width="200"/> | <img src="Screenshot 2026-03-18 at 17.58.35.jpg" width="200"/> | <img src="Screenshot 2026-03-18 at 17.59.14.jpg" width="200"/> | <img src="Screenshot 2026-03-18 at 17.59.57.jpg" width="200"/> |
...
The repository contains the main Streamlit application (`summ_gptoss20b.py`), the LangChain prompt template config (`template1.json`), and the necessary custom CSS for the deep-black UI.
...
- Minimum 16GB RAM (for running 20B parameter models)
...
**2) Pull the Model**
```bash
# Pull the model used for this project (replace with your specific model name if different)
ollama pull gpt-oss:20b..2